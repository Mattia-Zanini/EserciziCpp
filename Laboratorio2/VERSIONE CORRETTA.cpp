...
public:
  ...
  Rational(
      int); // costructor accepting int and representing it in rational form
...
void Rational::print_to_double() { std::cout << double(num) / double(den); }
...
int main() {
  ...
  std::cout << "I numeri razionali che rappresentano i fattori delle "
